  ...
  return (
    <Card className="w-full max-w-2xl mx-auto shadow-2xl border border-slate-200 bg-white rounded-2xl overflow-hidden">
      <CardHeader className="text-center pb-8 bg-gradient-to-br from-slate-50 to-white border-b border-slate-100">
        <div className="mx-auto mb-4 w-16 h-16 gradient-blue rounded-2xl flex items-center justify-center shadow-lg">
      ...
      <CardContent className="p-8">
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <Button
            type="submit"
            disabled={isLoading}
            className="w-full h-14 text-lg font-semibold gradient-blue hover:from-blue-600 hover:to-blue-700 shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200 rounded-xl text-white"
          >
            {isLoading ? (
